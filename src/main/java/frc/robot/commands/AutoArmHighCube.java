...
public class AutoArmHighCube extends SequentialCommandGroup {
  /** Creates a new AutoArmHighPos. */
  public AutoArmHighCube(ArmRotate armRotate, Pneumatics pneumatic, ArmExtend armExtend, Wrist wrist, Grabber grab) {
