...
public class Auto1NoteLeft extends SequentialCommandGroup {
  ...
  public Auto1NoteLeft(SwerveDriveWPI swerve, Shooter shoot, Processor process, Intake in, double speed, double dist, double ang, double heading, double endTime) {
