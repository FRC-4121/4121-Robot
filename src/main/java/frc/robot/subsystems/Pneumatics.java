...
public class Pneumatics extends SubsystemBase {
  ...
  private DoubleSolenoid climber = new DoubleSolenoid(ControlModuleID, PneumaticsModuleType.REVPH, ClimberOpenChannelID, ClimberCloseChannelID);
  ...
  public double getPressure(){
    return (250 * (pressureSensor.getVoltage()/pressureSensorVoltage))-25;//Equation for converting output voltage to psi
  }
